          ...
          <Card className="w-full max-w-2xl max-h-[90vh] overflow-auto">
            ...
            <CardContent className="space-y-4">
              <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg border border-blue-100 dark:border-blue-800 mb-4">
                <Label className="text-blue-800 dark:text-blue-300 mb-2 block">تحميل قالب جاهز (اختياري)</Label>
                <Select>
                  <SelectTrigger className="bg-white dark:bg-gray-800">
                    <SelectValue placeholder="اختر قالباً للبدء به..." />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="template1">قالب القوة البدنية الأساسي</SelectItem>
                    <SelectItem value="template2">قالب الكارديو وحرق الدهون</SelectItem>
                    <SelectItem value="template3">قالب المرونة واليوغا</SelectItem>
                    <SelectItem value="template4">قالب التأهيل الرياضي</SelectItem>
                  </SelectContent>
                </Select>
              </div>
