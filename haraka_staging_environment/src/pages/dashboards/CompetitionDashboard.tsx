        ...
        <CardContent className="pt-0">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4">
            <div className="text-center p-3 bg-white/10 rounded-lg">
              ...
              <div className="text-xs sm:text-sm text-yellow-100">إجمالي المسابقات</div>
            </div>
            <div className="text-center p-3 bg-white/10 rounded-lg">
              <div className="text-2xl font-bold">{activeCompetitions}</div>
              <div className="text-xs sm:text-sm text-yellow-100">مسابقة نشطة</div>
            </div>
            <div className="text-center p-3 bg-white/10 rounded-lg">
              <div className="text-2xl font-bold">{completedCompetitions}</div>
              <div className="text-xs sm:text-sm text-yellow-100">مسابقة مكتملة</div>
            </div>
            <div className="text-center p-3 bg-white/10 rounded-lg">
              <div className="text-2xl font-bold">{totalParticipants.toLocaleString()}</div>
              <div className="text-xs sm:text-sm text-yellow-100">إجمالي المشاركين</div>
            </div>
          </div>
        </CardContent>
      </Card>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="hidden md:block">
                  ...
                  <div className="text-xs text-gray-500">مدير المسابقات</div>
                </div>
              </div>
